...
class MainControllerTest < ActionController::TestCase
  ...
  test 'should return the home page' do
    ...
    assert_select 'title', 'Adopt-a-Stormwater'
    assert_select 'p#tagline', 'Claim responsibility for monitoring the water quality of a stormwater.'
  end
